...
const k3sVM = VirtualMachineFactory.createVM(`home-lab`, {
...
const domain = config.get('domain') ?? 'local';
const clusterName = config.get('clusterName') ?? k3sVM.hostname;
...
k3sVM.run('set-clusterName-and-domain', {
    create: interpolate`
...
export const homeIPv4 = k3sVM.ipv4;
export const homeFQDN = k3sVM.fqdn;
